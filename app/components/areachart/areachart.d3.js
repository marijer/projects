var AreaChart = function(config) {
	...
	function createAreaChart() {
		...
		xScale.range([ padding.left, size.w - padding.right ]);
		...
		stack(dataset);
			...
			var paths = continent.selectAll("path")
				.data(dataset)
				.enter()
				.append("path")
				.attr("class", "area")
			...
			continent.append("g")
				.attr("class", "x axis")
				.attr("transform", "translate(0," + (size.h - padding.bottom) + ")")
				.call(xAxis);
	...
	function setColor(continent){
		var brewer = '';
		switch(continent) {
			case 'ASIA':
				brewer = colorbrewer.BrBG[8];
				break;
			case 'SOUTH AMERICA':
				brewer = colorbrewer.BuPu[8];
				break;		
			case 'NORTH AMERICA':
				brewer = colorbrewer.YlOrRd[8];
				break;			
			case 'AFRICA':
				brewer = colorbrewer.Blues[8];
				break;			
			case 'EUROPE':
				brewer = colorbrewer.Greens[8];
				break;			
			case 'PACIFIC':
				brewer = colorbrewer.PiYG[8];
				break;			
			case 'SOUTH AMERICA':
				brewer = colorbrewer.PuOr[8];
				break;			
			default:
				brewer = colorbrewer.Spectral[8];
		}
